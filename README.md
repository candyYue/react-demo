...
import top from './top.png'; // Tell Webpack this JS file uses this image

console.log(top); // /top.84287d09.png

function Header() {
  // Import result is the URL of your image
  return <img src={top} alt="top" />;
}
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + '/img/top.png'} />;
}
```
